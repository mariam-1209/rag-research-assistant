...
if not st.session_state.docs_processed:
    ...
    with st.expander("ℹ️ How to Use This App"):
        st.markdown("""
**Step 1:** Get your free Groq API key at [console.groq.com](https://console.groq.com)

**Step 2:** Enter your API key in the sidebar

**Step 3:** Upload one or more PDF files using the sidebar

**Step 4:** Click "🚀 Process Documents" (takes 30-60 seconds first time)

**Step 5:** Ask questions about your documents in the chat!
...
with col3:
    st.metric("AI Model", "Llama3 via Groq")

st.markdown("---")
st.markdown("Built by **Mariam Noorani** | [GitHub](https://github.com/mariam-1209)")
